 ...
 * 
 */
@WebServiceClient(name = "SoapServiceImplService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/soap/SoapServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICEIMPLSERVICE_QNAME = new QName("http://soap/", "SoapServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/soap/SoapServiceImpl?wsdl");
    ...
    public SoapService getSoapServiceImplPort() {
        return super.getPort(new QName("http://soap/", "SoapServiceImplPort"), SoapService.class);
    }
    ...
    public SoapService getSoapServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "SoapServiceImplPort"), SoapService.class, features);
    }
